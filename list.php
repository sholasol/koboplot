...
<head>
    ...
    <!-- Title -->
    <title>Kobo Landlord | Listings</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading dark text-center">
                        <span></span>
                        <h4>Project Kobounits</h4>
                        <p>Investors choice</p>
                    </div>
                </div>
            </div>
            <div class="row">
               <?php
               $us= dbConnect()->prepare("SELECT * FROM project WHERE kobounit > 0  ORDER BY rand() LIMIT 6");
                $us->execute();
                while($ru=$us->fetch()){
               ?>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-features-area mb-50">
                        ...
                        <div class="price-start">
                            <p>FROM <?php echo number_format($ru['kobounit']); ?></p>
                        </div>
