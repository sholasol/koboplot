<?php include 'head.php'; ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <p>
                                                    A kobo Unit is a crowd funding opportunity for investors. With this feature, investors can invest in units of our Estate and Lands spread all over Lagos.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="widgets-personal-info-area" style="margin-top: 10px !important;">
                <div class="container-fluid">
                    <div class="row">
                        <?php 
                        $kp=  dbConnect()->prepare("SELECT * FROM project WHERE kobounit > 0");
                        $kp->execute();
                        while($r=$kp->fetch()){
                        $image=$r['image'];
                        $nm=$r['name'];
