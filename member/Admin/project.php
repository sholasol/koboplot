...
if(isset($_POST['save'])){
    ...
    elseif(empty($_POST['area'])){
     echo  " <script>alert('Please enter total units);</script>";   
    }
    elseif(empty($_POST['cost'])){
     echo  " <script>alert('Please enter cost of each kobounit);</script>";   
    }
    ...
    //Support Document
        ...
        $que = dbConnect()->prepare("INSERT INTO project SET name=:name, price=:price, markup=:markup, percent_markup=:percent, kobounit=:kobo, area=:area, address=:add, location=:loc, image=:image , status=:status, created=:created"); 
        $que->bindParam(':name', $pro);
        $que->bindParam(':area', $area);
        $que->bindParam(':add', $addr);
        $que->bindParam(':price', $price);
...
?>
                            ...
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        <div id="toolbar">
                                            <!--<a href="kobounit" ><i class="fa fa-map-pin btn cl"> Kobo Units</i></a> | 
                                            <a href="koboplot" ><i class="fa fa-map-marker btn cl"> Kobo Plots</i></a>-->
                                        </div>
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="area" >Area/Units</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $p= dbConnect()->prepare("SELECT * FROM project ORDER BY pID DESC");
                                                $p->execute();
                                                $counter = 0;
                                                while($r=$p->fetch()){
                                                    $id= $r['pID'];
    ...
    <div id="PrimaryModalhdbgc3" class="modal modal-adminpro-general default-popup-PrimaryModal fade" role="dialog">
        <div class="modal-dialog">
            <form method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header header-color-modal bg-color-1">
                           ...
                           <div class="row" style="margin-bottom: 20px;">
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                               <div class="col-lg-6">
                                    <div class="input-group date">
                                        <span class="input-group-addon"><i class="fa fa-area-chart"></i></span>
                                        <input type="number" name="area" id="area" onkeyup="calcKoboplot()" class="form-control" placeholder="Total Units" required>
                                    </div>
                                </div>
                               <div class="col-lg-6">
                                    <div class="input-group date">
                                        <span class="input-group-addon">=N=</span>
                                        <input type="number" name="cost" id="cost" class="form-control" step="0.1" placeholder="Price of Kobo Unit" required>
                                    </div>
                                </div>
                            </div>
                        <div class="row" style="margin-bottom: 20px;">
                ...
                <div class="modal-footer">
                    <button data-dismiss="modal" class="btn btn-default">Cancel</button>
                    <button type="submit" name="save" class="btn cl">Save Project</button>
                </div>
