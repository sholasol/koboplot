...
$us= dbConnect()->prepare("SELECT count(userID) AS num FROM users WHERE role='Client'");
$us->execute();
$ru=$us->fetch();
$num=$ru['num'];
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Investors</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="properties" >Properties</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $p= dbConnect()->prepare("SELECT * FROM users WHERE role='Client' ORDER BY userID DESC");
                                                $p->execute();
                                                $counter = 0;
                                                while($r=$p->fetch()){
                                                    $id= $r['userID'];
                                                    ...
                                                    $cus= dbConnect()->prepare("SELECT count(userID) AS count, sum(amount) AS sum FROM subscription WHERE userID='$id'");
                                                    $cus->execute();
                                                    $ro=$cus->fetch();
                                                    $sum=$ro['sum'];
                                                    $count=$ro['count'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  echo $r['email'].", ".$r['phone']; ?></td>
                                                    <td><?php  echo"=N= "; echo number_format($sum);?></td>
                                                    <td class="datatable-ct"><?php  echo number_format($count); ?><!--<span class="pie">1/6</span>-->
                                                    </td>
