...
$us= dbConnect()->prepare("SELECT count(subID) AS num FROM subscription WHERE status='Active'");
$us->execute();
$ru=$us->fetch();
$num=$ru['num'];
...
<!--                                            <table class="table small m-b-xs">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <strong>542</strong> Transactions
                                                        </td>
                                                        <td>
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="contact" >Investor</th>
                                                    <th data-field="investment" >Investment (=N=)</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $p= dbConnect()->prepare("SELECT * FROM subscription, project WHERE subscription.pID=project.pID AND subscription.status='Active' ORDER BY subscription.pID DESC");
                                                $p->execute();
                                                $counter = 0;
                                                while($r=$p->fetch()){
                                                    $id= $r['subID'];
                                                    ...
                                                    $cus= dbConnect()->prepare("SELECT count(userID) AS count, sum(amount) AS sum FROM subscription WHERE userID='$userid'");
                                                    $cus->execute();
                                                    $ro=$cus->fetch();
                                                    $sum=$ro['sum'];
                                                    $count=$ro['count'];
                                                    
                                                    $uss=  dbConnect()->prepare("SELECT * FROM users WHERE userID='$userid'");
                                                    $uss->execute();
                                                    $rw=$uss->fetch();
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  echo $r['address'].", ".$r['location']; ?></td>
                                                    <td><?php  echo $rw['name']." ".$rw['lname']; ?></td>
                                                    <td><?php  echo"=N= "; echo number_format($sum);?></td>
