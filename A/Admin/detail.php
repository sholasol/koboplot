                  ...
                  <div class="nav-wrapper">
                    <div class="left col s12 m5 l5">
                      <ul>
                        ...
                        <li><a href="#!" class="email-type">Subscription Details</a>
                        </li>
                      </ul>
                    </div>
                ...
                <div id="email-list" class="col s10 m4 l4 card-panel z-depth-1">
                  <ul class="collection">
                    ...
                    <li class="collection-item avatar email-unread">
                      ...
                      <span class="email-title">Amount Invested</span>
                      <p class="truncate grey-text ultra-small">Investment Amount</p>
                      <a href="#!" class="secondary-content"><span class="badge  darken-1"><?php echo number_format($price); ?></span></a>
                    </li>
                    <li class="collection-item avatar email-unread">
                      <i class="mdi-action-event icon yellow-text text-darken-3"></i>
                      <span class="email-title"><a  class="btn btn-info email-subject truncate" >Maturity: 2/02/2020</a></span>
                    </li>
                    <li class="collection-item avatar email-unread">
                      <i class="mdi-action-redeem icon green-text text-darken-3"></i>
                      <span class="email-title"><a  class="btn btn-info email-subject truncate" >Return (ROI): 200,000</a></span>
                    </li>
                  </ul>
                </div>
