            ...
            <!-- HORIZONTL NAV START-->
             <nav id="horizontal-nav" class="white hide-on-med-and-down">
                  ...
                  <ul id="nav-mobile" class="left hide-on-med-and-down">
                    ...
                    <li>
                        <a class="dropdown-menu cyan-text" href="#!" data-activates="Usersdropdown">
                            ...
                            <span>Manage Users<i class="mdi-navigation-arrow-drop-down right"></i></span>
                        </a>
                    </li>
                    <!--<li>
                        <a class="dropdown-menu cyan-text" href="#!" data-activates="Chartsdropdown">
                            <i class="mdi-editor-insert-chart"></i>
                            <span>Analytics<i class="mdi-navigation-arrow-drop-down right"></i></span>
                        </a>
                    </li>-->
                    <li>
                ...
                <ul id="Usersdropdown" class="dropdown-content dropdown-horizontal-list">
                    <li><a href="user.php"  class="cyan-text">Create User </a></li>
                    <li><a href="mUser.php"  class="cyan-text">Manage User</a></li>
                </ul>
                <!-- Profiledropdown -->
                ...
                <ul id="Chartsdropdown" class="dropdown-content dropdown-horizontal-list">
                    <li><a href="index.php?saleR" class="cyan-text">Sales Report</a></li>
                    <li><a href="index.php?projectR" class="cyan-text">Project Report</a></li>
                    <li><a href="index.php?clientR" class="cyan-text">Customer Report</a></li>
                </ul>
            <!-- HORIZONTL NAV END-->
                ...
                <ul id="slide-out" class="side-nav leftside-navigation ">
                    ...
                    <li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            ...
                            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-wallet-travel"></i> Manage Project</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="createP.php">Create Project</a>
                                        </li>
                                        <li><a href="manageP.php">Manage Project</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="bold"><a href="client.php" class="waves-effect waves-cyan"><i class="mdi-action-account-child"></i> Manage Clients </a>
                            </li>
                            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-account-box"></i> Manage User</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="user.php">Create User</a>
                                        </li>
                                        <li><a href="mUser.php">Manage Users</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
