          ...
          <div id="profile-page" class="section">
            ...
            <div id="profile-page-header" class="card">
                <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator" src="../own/images/user-profile-bg.jpg" alt="user background">                    
                </div>
                <figure class="card-profile-image">
                    <img src="../own/images/avatar.jpg" alt="profile image" class="circle z-depth-2 responsive-img activator">
                </figure>
                <div class="card-content">
                  <div class="row">                    
                    <div class="col s4 offset-s2">                        
                        <h4 class="card-title grey-text text-darken-4"><?php echo $name; ?></h4>
                        <p class="medium-small grey-text">Investor</p>                        
                    </div>
<!--                    <div class="col s2 center-align">
                    ...
                    <div class="col s2 center-align">
                        <h4 class="card-title grey-text text-darken-4"><?php echo $cust; ?></h4>
                        <p class="medium-small grey-text">No. of Investments</p>                        
                    </div>                    
                    <div class="col s3 center-align">
                        <h4 class="card-title grey-text text-darken-4"># <?php echo $sum; ?></h4>
                        <p class="medium-small grey-text">Total Investment</p>                        
                    </div>                    
                ...
                <div class="card-reveal">
                    <p>
                      ...
                      <span><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> Investor</span>
                    </p>
                    ...
                    <p><i class="mdi-action-event  cyan-text text-darken-2"></i> <?php echo $dat; ?></p>
                    <p><i class="vs cyan-text text-darken-2"></i> <?php echo $add; ?></p>
                </div>
            </div>
            <!--/ profile-page-header -->
