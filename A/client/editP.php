            ...
            <div class="row">
              <div class="col s12 m12 l6">
                <div class="card-panel">
                  <h4 class="header2">Edit Project</h4>
                  <div class="row">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <input id="password3" type="date" name="date" value="<?php echo $date ?>">
                        </div>
                      </div>
    ...
    if($imgFile)
    {
        ...
        if(in_array($imgExt, $valid_extensions)){			
              ...
              echo  " <script>alert('Sorry, only JPG, JPEG, PNG & GIF files are allowed.');</script>";		
                ...
                $proImage = $p_image; // old image from database
        }
     
     $query=$con->query("UPDATE project SET name='$pro', price='$price', location= '$loc', start ='$date', detail='$detail' , image='$proImage' WHERE pID='$pID' ");

     if($query){
         echo  " <script>alert('Project has been successfully Updated'); window.location='index.php?editP&id=$pID'</script>";
