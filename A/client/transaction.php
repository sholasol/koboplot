                         ...
                         <table id="data-table-simple"  cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Project</th>
                                    <th>Maturity Date</th>
                                    <th width="11%">Amount Invested (=N=)</th>
                                   <!-- <th>Transfer</th>-->
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <?php 
                                $total_inv=0;
                                $p=$con->query("SELECT * FROM subscription WHERE userID='$uid'");
                                ...
                                <tr>
                                   ...
                                   <!-- <td><a class="mdi-maps-local-atm" title="Transfer your investment in this project" href="#.php?id=<?php echo $ro['pID']; ?>" onclick="return confirm('Transfer your investment in this project?')"> </a></td>-->
                                </tr>
                                <?php } ?>
                            </tbody>
                          </table> <hr/>
